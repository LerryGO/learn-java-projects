...
import br.com.lapdev.med.voll.api.domain.consulta.Consulta;
import br.com.lapdev.med.voll.api.domain.endereco.DadosEndereco;
import br.com.lapdev.med.voll.api.domain.paciente.DadosCadastroPaciente;
import br.com.lapdev.med.voll.api.domain.paciente.Paciente;
...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        // When ou Act (Executa a ação do que quer testar)
        var medicoLivre = medicoRepository.escolherMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA, proximaSegundaAs10);

        // Then ou Assert (Verifica o resultado esperado)
    ...
    // ------------------ METODOS PARA POPULAR BANCO DE TESTES -------------------------
